...
parser.add_argument("--task", default='survival_prediction', type=str,
                    choices=["survival_prediction"],
                    help="task name to create data")
parser.add_argument("--output_dir", type=str,
                    default=ROOT_PATH / "output_mimic3")
...
def create_irregular_ts():
    ...
    #     ROOT_PATH /
    #     f"MMMSPG/ext/mimic3models/in_hospital_mortality/ihm_ts{args.timestep}.input_str:{args.imputation}.start_time:zero.normalizer"
    # )
