...
from cmehr.ext.mimic4benchmark.readers import MultimodalReader, Reader
...
'''
TODO: maybe we need to merge these preprocessing code into FairEHR repo. To make sure the consistent dataset preprocessing procedures.
python create_irregular_multimodal.py --dataset_path /disk1/fywang/EHR_dataset/mimiciv_fairness_benchmark/cxr
'''
...
class Discretizer_multi(Discretizer):
    ...
    def __init__(self, timestep=0.8, store_masks=True, impute_strategy='zero', start_time='zero',
                 config_path="/home/fywang/Documents/EHR_codebase/FairEHR/src/fairehr/dataset/mimic4/mimic4models/resources/discretizer_config.json",
                 channel_path="/home/fywang/Documents/EHR_codebase/FairEHR/src/fairehr/dataset/mimic4/mimic4models/resources/channel_info.json"
                 ):
...
def extract_irregular(dataPath_in, dataPath_out):
    ...
    #     ROOT_PATH / "src/fairehr/dataset/mimic4/mimic4models/resources/channel_info.json"))
    channel_info = json.load(channel_info_file)

    dis_config_file = open(config_path)
    # dis_config_file = open(str(
    #     ROOT_PATH / "src/fairehr/dataset/mimic4/mimic4models/resources/discretizer_config.json"))
