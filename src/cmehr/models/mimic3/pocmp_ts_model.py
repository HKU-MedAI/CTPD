...
class POCMPTSModule(MIMIC3LightningModule):
    '''
    ...
    def forward(self, x_ts, x_ts_mask, ts_tt_list,
        ...
        if self.use_prototype:
            ...
            concat_feat = torch.cat([concat_ts_slot, concat_ts_feat], dim=1)
        ...
        if self.task in ['ihm', 'readm']:
            if labels != None:
                ...
                loss_dict["total_loss"] = ce_loss + cont_loss * self.lamb1 + ts_recon_loss * self.lamb2
                return loss_dict
